...
<body class="with-side-menu">
					...
					<section class="card card-blue mb-3">
						...
						<div class="card-block">
							...
							if(isset($_SESSION['p_kategori'],$_SESSION['p_operator'])){
								...
								<?PHP
								$semua_data = $db->fetch_multiple("select * from p_pembelian where pembelianoperator_id='$p_operator' order by price ASC");
	...
	<script>
		...
		$('#table-edit').Tabledit({
				url: 'ajax/update_harga_produk.php',
				columns: {
					identifier: [0, 'id'],
					editable: [[2, 'product_name'], [5, 'price_add']]
				}
			});
	</script>
</body>
