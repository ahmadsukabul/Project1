...
<head lang="en">
	...
	<title>Produk Detail (Harga) JavaH2H - <?PHP echo $c_name; ?></title>
...
<body class="with-side-menu">
						...
						<div class="card-block">
							...
							if(isset($_SESSION['p_kategori'],$_SESSION['p_operator'])){
								...
								<table id="table-edit" class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<th>Harga Jual</th>
											<th>Keuntungan</th>
											<th>Price Sell (Toko)</th>
											<th>Status</th>
											<th><a href='h2h.php'>H2H ID</a></th>
											<th title='Di kunci artinya, produk harga status di kunci, jadi cron h2h tidak bisa merubah status dan harga produk ini'>Kunci?</th>
										</tr>
									</thead>
									<tbody>
								...
								<tr>
									...
									<td><?PHP echo $app->idr($harga_modal); ?></td>
									<td><?PHP echo $app->idr($harga_jual); ?></td>
									<td><?PHP echo $ambil_untung; ?></td>
									<td><?PHP echo $price_sell; ?></td>
									<td><?PHP echo $data['status']; ?></td>
									<td><?PHP echo $data['h2h_id']; ?></td>
									<td><?PHP echo $data['locked']; ?></td>
								</tr>
	...
	<script>
		...
		$('#table-edit').Tabledit({
				url: 'ajax/update_harga_produk2.php',
				columns: {
					identifier: [0, 'id'],
					editable: [[1, 'code'], [2, 'product_name'], [3, 'price'], [5, 'price_add'], [6,'price_sell'], [7,'status'], [8,'h2h_id'], [9,'locked']]
				}
			});
	</script>
</body>
